...
<div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
    <div class="flex flex-wrap items-center">
        <?php require '_side_section.view.php' ?>
        <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form id="register" action="/register" method="post">
                    <div class="flex flex-col md:flex-row gap-5.5 mb-4">
                        <div class="flex-1">
                            <label class="mb-2.5 block font-medium text-black dark:text-white">First
                                name</label>
                            <div class="relative">
                                <input type="text" name="first_name" placeholder="Enter your first name" value="<?= $old['first_name'] ?? '' ?>" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        ...
                        <div class="flex-1">
                            <label class="mb-2.5 block font-medium text-black dark:text-white">Last
                                Name</label>
                            <div class="relative">
                                <input type="text" name="last_name" placeholder="Enter your last  name" value="<?= $old['last_name'] ?? '' ?>" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            <input type="text" name="email" placeholder="Enter your email" value="<?= $old['email'] ?? '' ?>" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                    ...
                    <div class="mb-5">
                        <input type="submit" name="submit" value="Create account" class="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90" />
                    </div>
